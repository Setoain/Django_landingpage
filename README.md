...
in order to see the view with subscriber count and list.
...
For chatbot testing (windows): curl.exe -X POST http://127.0.0.1:8000/api/waitlist/chat/ -H "Content-Type: application/json" -d '{\"message\": \"EXAMPLE MESSAGE?\"}'
